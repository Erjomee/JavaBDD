                                                            ...
                                                            <div className="grid grid-cols-2 gap-3">
                                                                {projectProgrammers.map((prog) => (
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <button
                                                                            onClick={() => { setSelectedId(prog.id); handleUpdateProject(0); }}
                                                                            className="p-2 bg-orange-100 text-orange-700 rounded-lg hover:bg-orange-200 transition"
                                                                            title="Retirer du projet"
                                                                        >
                                                                            <UserMinus size={18} />
                            ...
                            <div className="p-6">
                                ...
                                {modalType === 'addProject' && (
                                    <div className="space-y-4">
                                        ...
                                        <div>
                                            <label className="block text-sm font-semibold text-gray-700 mb-2">Date début (YYYY-MM-DD)</label>
                                            <input type="text" name="dateDebut" value={formData.dateDebut} onChange={handleInputChange}
                                                   className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"/>
                                        </div>
                                        <div>
                                            <label className="block text-sm font-semibold text-gray-700 mb-2">Date fin (YYYY-MM-DD)</label>
                                            <input type="text" name="dateFin" value={formData.dateFin} onChange={handleInputChange}
                                                   className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"/>
                                        </div>
                                        <div>
